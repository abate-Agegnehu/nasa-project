...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/abate/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').default({tool: 'webpack', checkSum: '207ae0592278079b691fb3Ak9cBBsJCAsCW1NVClAGXwQHBwoD', mode: 'build'}); } catch(cjsError) { try { import('file:///home/abate/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '207ae0592278079b691fb3Ak9cBBsJCAsCW1NVClAGXwQHBwoD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
